...
about the user that posted the activity. Clicking on the top right icon allows you to log out. Logging out lead back to the login page.
...
our user interface. They all include logic for allowing communication between themselves, and the 3 microservices with no databases include logic for communicating with the frontend. The currently built microservices are:
