...
public class UserPageControllerTests {
    ...
    private UserPage createUserPage() {
        ...
        GameListDTO list1 = new GameListDTO("listid1", "mateiId", "matei's list", "matei's liked games", date, LocalDateTime.now());
        GameListDTO list2 = new GameListDTO("listid2", "ionescuId", "ione's list", "ione's liked games", date, LocalDateTime.now());
        GameListDTO list3 = new GameListDTO("listid3", "stoichId", "stoich's list", "stoich's liked games", date, LocalDateTime.now());
